...
export const RESUMES_QUERY = 'fetch/resumes';
export const COMPANIES_QUERY = 'fetch/companies';
export const PROFESSION_QUERY = 'fetch/profession';
export const RECRUITMENTS_QUERY = 'fetch/recruitments';
export const FIELDS_QUERY = 'fetch/fields';
export const PROFESSIONS_QUERY = 'fetch/professions';

export const FETCH_ONE_RECRUITMENT_QUERY = 'fetchOne/recruitment';
export const FETCH_ONE_COMPANY_QUERY = 'fetchOne/company';
export const RELATED_RECRUITMENT_QUERY = 'fetch/recruitments:related';

export const COMPANY_RECRUITMENTS = 'fetch/company:recruitments';

export const TOP_PROFESSIONS = 'fetch/top-professions';
