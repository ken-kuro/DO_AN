...
const InterestedItem = ({ recruitment, recruitmentId }: InterestedItemProps) => {
      ...
      <Grid container spacing={2}>
        <Grid item md={2} xs={12}>
          <Box
            ...
            onClick={() => router.push(`/company/${recruitment.company.id}`)}
          >
            <Box component="img" src={recruitment?.company?.avatar?.url} alt="" />
          </Box>
        </Grid>
          ...
          >
            ...
            >
              ...
              <LabelContent
                ...
                content={isInterested ? <Favorite fontSize="small" /> : <FavoriteBorder fontSize="small" />}
                sx={{
                  background: '#00b14f',
                  marginRight: 1,
                  color: '#fff',
